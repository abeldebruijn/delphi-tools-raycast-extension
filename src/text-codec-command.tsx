...
export function TextCodecCommand({ operation }: TextCodecCommandProps) {
...
function CodecForm({
  ...
  const resultText = getResultText(output, isProcessing, errorMessage);
  const canCopy = Boolean(output) && !errorMessage;
