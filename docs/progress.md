...
| [hash](./delphitools/hash.md) | Easy | Easy | ✗ | Not started |
...
| Tool | Extension hardness | Raycast ease | Native? | Progress |
| --- | --- | --- | --- | --- |
| [base](./delphitools/base.md) | Easy | Easy | ✓ | Not planned (already in Raycast core) |
| [calc](./delphitools/calc.md) | Easy | Easy | ✓ | Not planned (already in Raycast core) |
| [colour](./delphitools/colour.md) | Easy | Easy | ✓ | Not planned (already in Raycast core) |
| [glyph](./delphitools/glyph.md) | Easy | Easy | ✓ | Not planned (already in Raycast core) |
| [px2rem](./delphitools/px2rem.md) | Easy | Easy | ✓ | Not planned (already in Raycast core) |
| [rem2px](./delphitools/rem2px.md) | Easy | Easy | ✓ | Not planned (already in Raycast core) |
| [time](./delphitools/time.md) | Easy | Easy | ✓ | Not planned (already in Raycast core) |
| [typo](./delphitools/typo.md) | Easy | Easy | ✓ | Not planned (already in Raycast core) |
| [unit](./delphitools/unit.md) | Easy | Easy | ✓ | Not planned (already in Raycast core) |
| [word count](./delphitools/wc.md) | Easy | Easy | ✓ | Not planned (already in Raycast core) |
